...
date: "2025-02-05"
---
*Make sure to not forget the formatting that was asked for, feel free to reach out if you're having trouble!* 
...
barplot(probset, names.arg = x, space = 0, xlab = "Number of Calls", ylab = "Probability", main = "Poisson Mass Function") #I used plot instead of barplot, not sure if it matters
...
```
*This looks great, just again don't forget the formatting and picture he asked for!*